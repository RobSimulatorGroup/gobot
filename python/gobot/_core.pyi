...
class _IpcBatchSolverSession:
    ...
    @staticmethod
    def is_module_available(module_path: str = "") -> bool: ...
    def bind_device_buffers(self, buffers: Mapping[str, Any]) -> None: ...
    def set_cuda_stream(self, cuda_stream: int) -> None: ...
    def step(self, steps: int = 1) -> None: ...
    def reset(self) -> None: ...
...
class AppContext:
    ...
    def compile_scene_artifacts(self, backend_type: PhysicsBackendType = PhysicsBackendType.MuJoCoCpu, *, include_ipc: bool = False) -> dict[str, Any]: ...
    def compile_ipc_scene_artifact(self) -> dict[str, Any]: ...
    def _begin_external_simulation(
        self,
        step: Callable[[float], None],
        reset: Callable[[], None],
        sync_scene: Callable[[], None],
        close: Callable[[], None],
        fixed_time_step: float,
        max_sub_steps: int = 8,
    ...
    def _set_external_simulation_diagnostics(
        self, token: int, values: dict[str, Any]
    ) -> bool: ...
    ...
    def get_physics_state_view(self) -> dict[str, Any]: ...
