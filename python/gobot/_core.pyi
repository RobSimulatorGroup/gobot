...
class AppContext:
    ...
    def set_joint_position_targets(
        self, robot: str, joint_names: Sequence[str], target_positions: Sequence[float]
    ) -> None: ...
    ...
    def reset_joint_state(self, robot: str, joint: str, position: float, velocity: float = 0.0) -> None: ...
